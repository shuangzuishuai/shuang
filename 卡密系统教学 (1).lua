...
Start.MouseButton1Click:Connect(function()
    if Key.Text == "鬼哥最帅" then
        ScreenGui:Destroy()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/shuangzuishuai/1/main/%E9%AC%BC%E8%84%9A%E6%9C%AC%E6%BA%90%E7%A0%81.lua"))()
    else
        game.Players.LocalPlayer:Kick("卡密错了操你妈 自私")
    end
end)