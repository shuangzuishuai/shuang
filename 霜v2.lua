...
local Window = OrionLib:MakeWindow({Name = "霜中心", HidePremium = false, SaveConfig = true,IntroText = "霜中心", ConfigFolder = "霜中心"})
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "霜中心"; Text ="霜中心"; Duration = 4; })
...
Tab:AddButton({
    ...
    Callback=function()
        ...
        loadstring(game:HttpGet("https://shz.al/~doors11"))()
